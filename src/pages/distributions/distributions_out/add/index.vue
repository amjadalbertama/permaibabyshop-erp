        ...
        <div class="col-lg-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-description">Add your data distribution Out</p>
              ...
              <form class="forms-sample">
                    ...
                    <div class="row">
                      <div class="col-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                          ...
                          <select class="form-control p_input" id="branch" :class="{'is-invalid': errors.has('branch')}" placeholder="Choose Your Branch Here..." v-model="dist_out.branch_id" name="branch_id" data-vv-name="branch" v-validate data-vv-rules="required">
                      ...
                      <div class="col-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                          ...
                          <textarea class="form-control form-control-lg textarea-custom" id="notes" rows="5" v-model="dist_out.note"></textarea>
                        </div>
                      </div>
                      <!-- <div class="col-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                          <label for="type">Type</label>
                          <input type="type" class="form-control p_input" :class="{'is-invalid': errors.has('type')}" id="type" placeholder="Type Your Types Here..." v-model="dist_out.type" name="type" data-vv-name="type" v-validate data-vv-rules="required">
                          <label id="type-error" class="error mt-2 text-danger d-none" for="type">{{ errors.first('type') }}</label>
                        </div>
                      </div> -->
                      <div class="col-12 col-md-12">
                        <!-- <div class="form-group">
                ...
                <div class="row mt-5">
                  <div class="col-12 col-md-12 text-end">
                    <button type="submit" class="btn btn-primary me-2" @click="createDo">Submit</button>
    ...
    export default {
      ...
      methods: {
        ...
        createDo: function (e) {
          ...
          var data = self.dist_out
          self.$store.dispatch('saveDistributionOut', {data,
            success: function (res) {
              self.loading = false
              if (res.body.success) {
                self.$toastr.s(res.body.message)
                self.$router.push('/distributions/out/list/1')
              } else {
                self.$toastr.e(res.body.message)
              }
            },
            error: (err) => {
              console.log(err)
