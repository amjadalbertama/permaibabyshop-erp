          ...
          <div class="card px-2">
            <div class="card-body">
              <div class="container-fluid">
                <h3 class="text-end my-5">Distribution In&nbsp;&nbsp;#INV-1234</h3>
                <hr>
              </div>
              <div class="container-fluid d-flex justify-content-between">
                ...
                <div class="col-lg-3 pe-0">
                  <p class="mt-5 mb-2 text-end"><b>Distribution In to</b></p>
                  <p class="text-end">Supplier 1,<br> C-201, Beykoz-34800,<br> Canada, K1A 0G9.</p>
                </div>
              </div>
              <div class="container-fluid d-flex justify-content-between">
                <div class="col-lg-3 ps-0">
                  <p class="mb-0 mt-5">Distribution In Date : {{ $moment().format("DD MMMM YYYY") }}</p>
