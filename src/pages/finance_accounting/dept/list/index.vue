                  ...
                  <div class="card-body">
                    <div class="dropdown mb-3">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                          <li><a class="dropdown-item" href="#" actived>Hutang Jangka Panjang</a></li>
                          <li><a class="dropdown-item" href="#">Hutang Lancar Lainya</a></li>
                        </ul>
                    </div>
                  </div>
                </div>
                                            ...
                                            <table class="table mb-3" style="width: 30%;">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-white" style="border: none;">Hutang Dagang</td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                ...
                                                <tr >
                                                    ...
                                                    <td class="text-white">2010-AXARVA MEDIA TEKNOLOGI</td>
